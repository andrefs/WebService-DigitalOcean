...
is_deeply($do->do_request(api_action => 'images'),{
  images => [
              { distribution => "Ubuntu", id => 429, name => "Real Backup 10242011" },
              { distribution => "Ubuntu", id => 430, name => "test233" },
              { distribution => "Ubuntu", id => 431, name => "test888" },
              { distribution => "Ubuntu", id => 442, name => "tesah22" },
              { distribution => "Ubuntu", id => 443, name => "testah33" },
              { distribution => "Ubuntu", id => 444, name => "testah44" },
              { distribution => "Ubuntu", id => 447, name => "ahtest55" },
              { distribution => "Ubuntu", id => 448, name => "ahtest66" },
              { distribution => "Ubuntu", id => 449, name => "ahtest77" },
              { distribution => "Ubuntu", id => 458, name => "Rails3-1Ruby1-9-2" },
              { distribution => "Ubuntu", id => 466, name => "NYTD Backup 1-18-2012" },
              { distribution => "Ubuntu", id => 478, name => "NLP Final" },
              { distribution => "Ubuntu", id => 540, name => "API - Final" },
              { distribution => "Ubuntu", id => 577, name => "test1-1" },
              { distribution => "Ubuntu", id => 578, name => "alec snapshot1" },
            ],
  status => "OK",
}, $do->_apiurl.'images'); 
